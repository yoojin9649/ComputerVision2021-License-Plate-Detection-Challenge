...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_epochs', type=int, default=30, help='total epoch to train')
    ...
    parser.add_argument('--savedir', default="SLPNetSave5") # The save path, under folder -- ./weight
